...
st.title("Bienvenida a tu espacio, mi amor ❤️")
...
st.image("https://images.unsplash.com/photo-1518192167132-801905307b4a?auto=format&fit=crop&q=80&w=800", caption="¡Te amo!") # Es una imagen de ejemplo de unos corazones
